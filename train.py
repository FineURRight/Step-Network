...
if __name__ == '__main__':
    ...
    model.load_networks(which_epoch=200000)
    # model = model.to()  
    # create a visualizer
    ...
    while(keep_training):
        ...
        for i, data in enumerate(dataset):
            ...
            if total_iteration % opt.display_freq == 0:
                save_result = total_iteration % opt.save_img_freq == 0
                visualizer.display_current_results(model.get_current_visuals(), epoch, total_iteration, save_result)
