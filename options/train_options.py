...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--niter', type=int, default=20000, help='# of iter with initial learning rate')
        ...
        parser.add_argument('--save_img_freq', type=int, default=1000, help='frequency of saving the latest results')
