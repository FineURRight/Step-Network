...
class BaseOptions():
    ...
    def initialize(self, parser):
        # base define
        parser.add_argument('--name', type=str, default='fashion', help='name of the experiment.')
        #parser.add_argument('--model', type=str, default='rec', help='name of the model type.')
        parser.add_argument('--model', type=str, default='painet', help='name of the model type.')
        ...
        parser.add_argument('--par_nc', type=int, default=8)
        parser.add_argument('--keypoint_nc', type=int, default=18)
